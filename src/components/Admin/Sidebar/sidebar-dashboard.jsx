  ...
  return (
    <div className={`app-sidebar ${collapsed ? "collapsed" : ""}`}>
      ...
      <nav className="sidebar-nav">
          <Link to="/admin" className={`sidebar-nav-link ${isActive("/admin") ? "active" : ""}`}>
          <svg className="sidebar-nav-icon" viewBox="0 0 24 24" fill="currentColor">
            <path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z" />
          </svg>
          {!collapsed && "Dashboard"}
        </Link>
        <Link to="/admin/profile" className={`sidebar-nav-link ${isActive("/admin/profile") ? "active" : ""}`}>
          <svg className="sidebar-nav-icon" viewBox="0 0 24 24" fill="currentColor">
            <path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z" />
          </svg>
          {!collapsed && "Profile"}
        ...
        <Link to="/admin/booking" className={`sidebar-nav-link ${isActive("/admin/booking") ? "active" : ""}`}>
          <svg className="sidebar-nav-icon" viewBox="0 0 24 24" fill="currentColor">
        ...
        <Link to="/admin/vehicle" className={`sidebar-nav-link ${isActive("/admin/vehicle") ? "active" : ""}`}>
          <svg className="sidebar-nav-icon" viewBox="0 0 24 24" fill="currentColor">
            <path d="M5 16h14v2H5zm0-8h14v6H5zm0-4h14v2H5z" />
          </svg>
          {!collapsed && "Vehicle Fleet"}
        </Link>

        <Link to="/admin/rating" className={`sidebar-nav-link ${isActive("/admin/rating") ? "active" : ""}`}>
          <svg className="sidebar-nav-icon" viewBox="0 0 24 24" fill="currentColor">
        ...
        <Link to="/admin/complain" className={`sidebar-nav-link ${isActive("/admin/complain") ? "active" : ""}`}>
          <svg className="sidebar-nav-icon" viewBox="0 0 24 24" fill="currentColor">
